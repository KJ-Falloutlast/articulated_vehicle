...
if("TRUE" STREQUAL "TRUE")
  set(pid_SOURCE_PREFIX /home/kim-james/Tractor_ws/Run/articulated_vehicle_new_ws/src/mrobot_controller/pid)
  set(pid_DEVEL_PREFIX /home/kim-james/Tractor_ws/Run/articulated_vehicle_new_ws/devel)
  set(pid_INSTALL_PREFIX "")
  set(pid_PREFIX ${pid_DEVEL_PREFIX})
else()
  set(pid_SOURCE_PREFIX "")
  set(pid_DEVEL_PREFIX "")
  set(pid_INSTALL_PREFIX /home/kim-james/Tractor_ws/Run/articulated_vehicle_new_ws/install)
...
if(NOT "/home/kim-james/Tractor_ws/Run/articulated_vehicle_new_ws/devel/include;/home/kim-james/Tractor_ws/Run/articulated_vehicle_new_ws/src/mrobot_controller/pid/include " STREQUAL " ")
  set(pid_INCLUDE_DIRS "")
  set(_include_dirs "/home/kim-james/Tractor_ws/Run/articulated_vehicle_new_ws/devel/include;/home/kim-james/Tractor_ws/Run/articulated_vehicle_new_ws/src/mrobot_controller/pid/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pid' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kim-james/Tractor_ws/Run/articulated_vehicle_new_ws/src/mrobot_controller/pid/${idir}'.  ${_report}")
    endif()
